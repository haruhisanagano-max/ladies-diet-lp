		...
		<div class="wrapper">
			<div class="reduce gs">
				...
				<div class="inner">
					...
					<div class="main_fv"><img src="./images/top/mainImg.png" alt=""></div>
				</div>
			</div>
			<div class="result gs">
				<div class="inner">
			...
			<div class="body gs point" id="jump3">
				...
				<div class="body-content">
					...
					<div class="item_add">
						<p class="tac"><img src="./images/top/add_price202601.png" class="" alt=""></p>
						
					</div>
					<div class="item_add">
						<p class="tac"><img src="./images/top/add_price01.png" class="" alt=""></p>
						
					</div>
					<div class="item_add">
						<p class="tac"><img src="./images/top/add_price02.png" class="" alt=""></p>
						...
						<div class="click-content-inner">
							...
							<div class="texts">
								...
								<p class="text3">〒604-8073
									<br/>京都府京都市中京区六角通柳馬場東入大黒町71 
									<br/>イーグルコート京都六角雅心庵2階F号室
